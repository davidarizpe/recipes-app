...
INSERT INTO "new_Recipe" ("carbs", "cookTime", "createdAt", "description", "fat", "id", "ingredients", "protein", "servig_grams", "serving", "title", "userId") SELECT "carbs", "cookTime", "createdAt", "description", "fat", "id", "ingredients", "protein", "servig_grams", "serving", "title", "userId" FROM "Recipe";
DROP TABLE "Recipe";
